            ...
            <details className="border border-stone-300 rounded-lg overflow-hidden">
              ...
              <div className="px-4 py-4 relative">
                <div className="flex justify-end mb-2">
                  <CopyButton getText={() => `# Tool Scoping Feedback Skill\n\nDraft feedback on a student's Tool Scoping Worksheet.\n\n## Context\n\nStudents completed a Tool Scoping Worksheet where they described a Custom GPT they want to build to give their team feedback. The worksheet asks:\n- The feedback they keep giving over and over\n- What kind of work they give it on\n- Who they give it to\n- When the person would reach for this Custom GPT\n- The steps the GPT would walk through\n- What "good" looks like (evaluation criteria)\n\nThe goal of the tool is to give feedback the way the manager would, so the manager isn't the bottleneck.\n\n## How to Draft Feedback\n\n### Length and structure\nFeedback should be 250-400 words. Use this structure:\n1. Opening - one sentence max. Validate something specific (not generic praise).\n2. "A couple things to think about:" - transition line\n3. "First... Second... Third..." - numbered points, each a full paragraph with reasoning and a concrete suggestion\n4. Bonus insight (when natural) - a workflow tip, adjacent idea, or provocative pushback\n\nGive the advice now. Never say "we'll talk about this in Session 2." Give concrete techniques, not just principles.\n\n### Step 1: Understand what they're building\nTranslate the tool into plain language. What does it actually do, who uses it, and why?\nIdentify what type of tool this is - or more often, what combination:\n- Evaluator: Takes finished work and checks it against criteria. Pass/fail.\n- Coach: Walks someone through the thinking process. Asks questions, helps them improve.\n- Automation: Just does the work. No evaluation, no coaching.\n- Extraction/transformation: Takes messy input, pulls out what matters, produces structured output.\n\n### Step 2: Challenge the problem framing\nDon't take the stated problem at face value. The student describes their pain, but that's the symptom. What's the underlying cause? When the problem could be read multiple ways, always name the 2-3 most likely interpretations and let the student tell you which resonates. Don't pick one and run with it.\n\n### Step 3: Separate whose problem this is\nFlip from the manager's frustration to the user's experience. What's their emotional state? If the task feels like a chore, a tool that adds more work won't get used.\n\n### Step 4: Apply the 10x rule\nWould getting 10x better at this make someone meaningfully better at their job? If yes, coach them. If no, just do it for them. The best tools do both.\n\n### Step 5: Check the scope\nToo many formats? Too many audiences? Pick one, get it working, then expand.\nToo many dimensions - or actually two tools? When criteria represent fundamentally different skills, don't just say "narrow the scope" - say "I think you actually have two tools here, and they're both interesting." That framing is generous (you have more than you realized) rather than reductive (do less). Name each tool and describe what it does.\n\n### Step 6: Check whether the criteria match the real bar\nFormal criteria often don't match what people actually evaluate in their head. The instinctive answer is usually more useful.\n\n### Step 7: Fix the evaluation approach\nNumeric scores create false precision. Use pass/fail instead.\n\n### Step 8: Design for the user's experience\nDon't give people a blank page - give them something to react to. Sequence steps rather than evaluating everything at once. Lead with corrections, not evaluation.\n\n### Step 9: Think about what the AI needs to succeed\nReference data goes in the prompt or knowledge base. If the domain is well-known, the AI already has strong intuitions. If someone can't articulate criteria, feed it 3-6 examples and let it identify patterns.\n\n### Step 10: Think beyond the single tool\nHow does this fit into the person's actual workflow? Could it be more useful at a different point in the process? Paint a picture of what the tool feels like to use - describe the experience, not just what it evaluates.\n\n### Step 11: Tone and framing\nLead with what's strong. Frame suggestions as evolution, not correction. Be direct but not harsh. Be generous about what AI can do.\n\n### Step 12: The tool should do the work\nWhen suggesting the tool surface something (gaps, objections, patterns), also suggest the tool act on it. Don't just flag issues - have the tool draft the fix.\n\n### Step 13: Think about adoption\nWill people actually reach for this tool? The name, framing, and first impression matter.`} />
                </div>
                <pre className="text-stone-700 text-xs leading-relaxed whitespace-pre-wrap font-mono">{`Length and structure
Feedback should be 250-400 words. Opening is one sentence max - validate something specific, not generic praise. Then "A couple things to think about:" followed by numbered points, each a full paragraph with reasoning and a concrete suggestion. Give the advice now. Never defer to future sessions.
...
Step 2: Challenge the problem framing
Don't take the stated problem at face value. The student describes their pain ("I keep giving this feedback"), but that's the symptom. What's the underlying cause? When the problem could be read multiple ways, always name the 2-3 most likely interpretations and let the student tell you which resonates. Don't pick one and run with it.
...
Step 12: The tool should do the work
When suggesting the tool surface something (gaps, objections, patterns), also suggest the tool act on it. Don't just flag issues for the user to solve - have the tool draft the fix.

Step 13: Think about adoption
Will people actually reach for this tool? The name, framing, and first impression matter. "Get a script for a difficult conversation" lands differently than "Radical Candor feedback coach."`}</pre>
              </div>
            </details>
          </div>
