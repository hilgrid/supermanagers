        ...
        {filePlatform && (
          <div className="mb-16">
            ...
            <ol className="text-stone-800 text-base leading-relaxed space-y-3 mb-4 list-decimal list-inside">
              <li>Fix this update: <InlinePrompt text={`My manager replied to my weekly update with these questions: "Can you be more specific about what you need from me on the blocked item? Who exactly do you need me to reach out to, and what do you need me to say? And for the thing that's at risk - is that a resource issue or a scope issue? I want to help but I need to know what 'help' looks like." Rewrite the update to address them.`} /></li>
              <li>Fix the system: <InlinePrompt text={`Look at my manager's follow-up questions: "Can you be more specific about what you need from me on the blocked item? Who exactly do you need me to reach out to, and what do you need me to say? And for the thing that's at risk - is that a resource issue or a scope issue? I want to help but I need to know what 'help' looks like." What's the note behind the note here - what themes can you pull out about what my manager actually wants from these updates? Then show me how to update the weekly update writer skill so future updates address these patterns automatically.`} /></li>
            </ol>
