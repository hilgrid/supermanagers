...
const weeks: Week[] = [
  {
    ...
    items: [
      ...
      { id: 'w1-notes', type: 'notes', label: 'Notes from live session 1', href: '/session1-notes', external: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'w2-notes', type: 'notes', label: 'Notes from live session 2', href: '/session2-notes', external: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'w3-notes', type: 'notes', label: 'Notes from live session 3', href: '/session3-notes', external: false },
    ],
  },
  {
    week: 4,
